...
public class DividerItemDecorationn extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecorationn(Context context, AttributeSet attrs) {
    ...
    public DividerItemDecorationn(Context context, AttributeSet attrs, boolean showFirstDivider,
    ...
    public DividerItemDecorationn(Context context, int resId) {
        mDivider = ContextCompat.getDrawable(context, resId);
    }

    public DividerItemDecorationn(Context context, int resId, boolean showFirstDivider,
                                  boolean showLastDivider) {
        this(context, resId);
        mShowFirstDivider = showFirstDivider;
        mShowLastDivider = showLastDivider;
    ...
    public DividerItemDecorationn(Drawable divider, boolean showFirstDivider,
                                  boolean showLastDivider) {
        this(divider);
        mShowFirstDivider = showFirstDivider;
        mShowLastDivider = showLastDivider;
        ...
        if (mOrientation == -1) {
            if (parent.getLayoutManager() instanceof LinearLayoutManager) {
                ...
                throw new IllegalStateException(
                        "DividerItemDecorationn can only be used with a LinearLayoutManager.");
            }
        }
        return mOrientation;
    }
